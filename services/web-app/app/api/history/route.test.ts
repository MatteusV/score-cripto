...
const MOCK_HISTORY_RESPONSE = {
  ...
  data: [
    { id: "r1", chain: "ethereum", address: "0xabc", score: 85,
      requestedAt: "2026-04-13T10:00:00Z", completedAt: "2026-04-13T10:01:00Z" },
  ],
...
describe("GET /api/history", () => {
  ...
  it("should forward page and limit query params to api-gateway", async () => {
    ...
    vi.mocked(fetchWithAuthJson).mockResolvedValue({
      ok: true, status: 200, data: MOCK_HISTORY_RESPONSE,
    })
