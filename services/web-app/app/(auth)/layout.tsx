    ...
    <div className="flex min-h-svh flex-col">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 pt-6 md:px-10">
        <Link className="group flex items-center gap-3" href="/">
          <div className="flex size-10 items-center justify-center rounded-2xl border border-border/50 bg-card/60 font-bold text-primary text-xs tracking-[0.2em] backdrop-blur-sm transition-colors group-hover:border-primary/40">
            SC
          </div>
          <div className="hidden sm:block">
            ...
            <p className="text-muted-foreground text-xs">Confiança on-chain</p>
          </div>
        </Link>
      </header>
