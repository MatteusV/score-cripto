...
export function createMockWalletContext(overrides: Partial<WalletContextInput> = {}): WalletContextInput {
  return {
    chain: "ethereum",
...
export function createRiskyWalletContext(overrides: Partial<WalletContextInput> = {}): WalletContextInput {
  return {
    chain: "ethereum",
    ...
    nft_activity: false,
    defi_interactions: 0,
    risk_flags: ["tornado_cash_interaction", "ofac_sanctioned_counterparty", "rapid_fund_movement"],
    ...overrides,
  };
}
