...
const BASE_URL =
  ...
  "postgresql://score_cripto:score_cripto@localhost:5433/score_cripto_scoring";

const TEST_SCHEMA = `e2e_${Date.now()}`;
const TEST_DATABASE_URL = `${BASE_URL}?schema=${TEST_SCHEMA}`;
...
export async function setup(): Promise<void> {
  ...
  // Passa schema e URL via variáveis de ambiente para setupFiles ler
